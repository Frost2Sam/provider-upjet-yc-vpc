...
PROJECT_NAME ?= provider-upjet-yc-vpc
PROJECT_REPO ?= github.com/frost2sam/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-yandex_v0.112.0_x5
...
xpkg.build.provider-upjet-yc-vpc: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/upjet-yc-vpcs/01-delete.yaml.tmpl.
